...
def main() -> None:
    ...
    require(core_tests_cpp, "SubtitleGenerator lets wrapped highlighted rows consume one extra visual line", "core tests wrapped highlighted spacing")
    ...
    require(core_tests_cpp, "SubtitleGenerator lets wrapped grayed rows consume one extra visual line", "core tests wrapped grayed spacing")
