...
def main() -> None:
    ...
    require(project_cpp, "Project::Project(KarData& projectData) : videoPath(\"\"), data(projectData)", "Project injected data constructor")
    require(project_cpp, "SubtitleGenerator::ToRichAss(data)", "Project injected data preview")
    require(project_cpp, "SaveProjectDlg().Run(data)", "Project injected data save")
    ...
    require(main_window_cpp, "MainWindow::MainWindow(KarData& data) : data(data), wizardDlg(data), project(data), projects(data, wizardDlg)", "MainWindow injected data constructor")
    ...
    require(page1_cpp, "Page1::Page1() : Page1(KarData::GetGlobal())", "Page1 default global data wiring")
    ...
    require(page2_cpp, "Page2::Page2() : Page2(KarData::GetGlobal())", "Page2 default global data wiring")
